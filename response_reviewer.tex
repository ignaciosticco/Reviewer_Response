...
% REVISAR ESTE ITEM 
3) In page 10: The reviewer argues that we cannot refer to $\mathcal{A}$ and $\mathcal{K}$ like we did (with no previous introduction). He (she) proposes that the equations of Appendix A can be introduced there. We followed his (her) suggestion and Eq. 13 and Eq. 14 now appear in here (now page 11) to give a more appropriate presentation to the parameters $\mathcal{A}$ and $\mathcal{K}$.\\
