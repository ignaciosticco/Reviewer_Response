...
The empirical measurements of L\"ohner (L\"ohner PED 2016 in Hefei) show that pedestrians closer to the inner boundary of the Kaaba, move slower than the pedestrians in the outer boundary. This result is consistent with our simulation since the inner boundary is a wall and the outer boundary is an open-bound. Thus, pedestrians near close to the wall move slower than pedestrians away from the wall. Nevertheless, the comparison is not straightforward since the geometry of the Kaaba, is not strictly a corridor. At the moment the literature lacks of measurements of unidirectional flow in extreme density situations.  
