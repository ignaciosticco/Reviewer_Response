...
The velocity profile resembles the velocity profile measured in Ref. https://doi.org/10.1016/j.physa.2013.02.019. In this work, the authors measure the velocity profile of pedestrians walking along a straight corridor. We decided to include this reference in the manuscript to provide empirical support to the simulated results. \\
